  ...
  async function handleSubmit() {
    try {
      ...
      if (!res.ok) {
        ...
        setError({ Type: "Success", Message: "Account created, please login" })
      }
    ...
    <div className="bg-[url('/blackandgold.png')] bg-cover bg-center justify-center flex  min-h-screen p-8 pb-20  sm:p-20">
      <div className="flex items-center flex-col bg-gray-100 w-[320px] h-[450px] mt-15 ">
        <div className="flex flex-col mt-4">
          ...
          <h1 className="text-gray-200 font-semibold  text-center mt-2 bg-black   p-2 "> Proposal Portal </h1>
          <form>
            <div className="flex flex-col">
              <label htmlFor="email" className="text-sm text-black font-bold mt-5"> Email Address </label>
              <input
                id="email"
                name="email"
              ...
              />
              <label htmlFor="Name" className="text-sm text-black font-bold mt-5">Full Name</label>
              <input
                id="name"
          ...
          <div className="flex flex-col justify-baseline items-end w-full mt-1">
            <button onClick={() => handleSubmit()} className="bg-black hover:text-amber-500 font-bold  p-2 cursor-pointer">
              Sign Up
            </button>
            <h3 className='text-black text-sm'> or <span className='text-black hover:text-amber-500 hover:cursor-pointer' onClick={() => router.push("/login")}>Sign In</span></h3>
