                            ...
                            <div className="max-w-7xl md:max-w-5xl bg-gray-200/20 p-5">
                                <div className="flex gap-2 items-baseline-center">
                                    <div className="flex gap-2">
                                        <div className={`${getColorFromName(student.major.name)} w-15 h-10 justify-center items-center flex`}>
                                            <h2 className="font-bold text-md text-black">{translateDegree(student.major.level)}</h2>

                                        </div>
                                        <div className="flex flex-col">
                                            <h1 className="font-bold text-md text-slate-500">{student.major.name}</h1>
                                            <h1 className="font-bold text-xs text-slate-600">Graduation: {student.major.gradYear}</h1>
                            ...
                            <div>
                                ...
                                <div className="max-w-7xl md:max-w-5xl bg-gray-200/20 p-5">
                                    {student.skills.map((skills, index) =>(
                                        <div className="bg-red-500 gap-2">
                                            {skills}
                                        </div>
