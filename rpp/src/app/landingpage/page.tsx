    ...
    return (
        ...
        <div className="min-h-screen bg-gradient-to-r from-yellow-400 via-amber-400 to-yellow-500 flex flex-col">
            ...
            <header className="flex justify-between bg-black items-center px-12 py-6">
                {/* Logo / Brand Name */}
                <h1
                    className={`${fingerpaint.className} text-3xl font-bold text-white`}
                >
                    Retriever
                    <span className="text-amber-700"> Proposal Portal</span>
                </h1>
                ...
                <div className=" ml-30 mb-14">
                    <div className="flex justify-around">
                        <div className="flex flex-col max-w-2xl">
                            <h2
                                className={`${fingerpaint.className} text-6xl font-bold text-black mb-6`}
                            >
                                Imagination Becomes REALITY
                            </h2>
                            <p className="text-black/80 text-lg leading-relaxed">
                                The Retriever Proposal Portal bridges creativity
                                and collaboration at UMBC. It’s a space where
                                students, faculty, and industry partners can
                                present innovative ideas, explore potential
                                solutions, and contribute to real projects that
                                enhance campus life. Whether proposing,
                                supporting, or testing new initiatives,
                                Retrievers can turn classroom knowledge into
                                tangible, community driven impact.
                            </p>
